...
this["JST"]["album"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<figure><img src="
    ...
    + "><h2><a href=\""
    + alias4(((helper = (helper = helpers.tracksUrl || (depth0 != null ? depth0.tracksUrl : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tracksUrl","hash":{},"data":data}) : helper)))
    + "\">"
    ...
    + "</p><a class=\"btn\" href=\"#\"><i class=\"fa fa-shopping-cart\"></i>add to cart</a></figure>";
},"useData":true});

this["JST"]["cart"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<label for=\"cart_toggle\"><i class=\"fa fa-shopping-cart\"></i> "
  ...
  return "<li data-id=\""
    ...
    + " x "
    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
    + "</p><a href=\"#\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></a><span>"
    + alias4((helpers.format_price || (depth0 && depth0.format_price) || alias2).call(alias1,(depth0 != null ? depth0.price : depth0),{"name":"format_price","hash":{},"data":data}))
    + "</span></li>";
},"4":function(container,depth0,helpers,partials,data) {
    return "<p><i class=\"fa fa-shopping-cart\"></i> 0 items</p>";
...
this["JST"]["index"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1>Albums</h1><div id=\"albums\"></div><footer><a class=\"btn\" href=\"/albums/new\">Add New Album</a></footer>";
},"useData":true});

this["JST"]["new_album"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form action=\"/albums\" method=\"post\"><h1>Add Album</h1><fieldset><dl><dt><label>Title:</label></dt><dd><input type=\"text\" name=\"title\" autofocus=\"autofocus\"/></dd><dt><label>Artist:</label></dt><dd><input type=\"text\" name=\"artist\"/></dd><dt><label>Date:</label></dt><dd><input type=\"date\" name=\"date\"/></dd><dt><label>Cover</label></dt><dd><input type=\"url\" name=\"cover\"/></dd><dt><label>Price</label></dt><dd><input type=\"text\" name=\"price\"/></dd></dl></fieldset><fieldset class=\"actions\"><input type=\"submit\" value=\"Create\" class=\"btn\"/></fieldset></form>";
},"useData":true});